...
const Type = (props) => {
    const [AttackType, setAttackType] = React.useState([
        ...
        },
        {
            name: 'Water',
            on: false,
            against: [1, 2, 0.5, 0.5, 1, 1, 2, 2, 1, 1, 1, 1, 1, 1, 0.5, 1, 1, 1],
        },
        {
            name: 'Grass',
            on: false,
        ...
        },
        {
            name: 'Electric',
            on: false,
            against: [1, 1, 2, 0.5, 0.5, 1, 1, 0, 2, 1, 1, 1, 1, 1, 0.5, 1, 1, 1],
        },
        {
            name: 'Ice',
            on: false,
            against: [1, 0.5, 0.5, 2, 1, 0.5, 1, 2, 2, 1, 1, 1, 1, 1, 2, 1, 0.5, 1],
        },
        {
            name: 'Rock',
            on: false,
            against: [1, 2, 1, 1, 1, 2, 1, 0.5, 2, 1, 0.5, 2, 1, 1, 1, 1, 0.5, 1],
        },
        {
            name: 'Ground',
            on: false,
            against: [1, 2, 1, 0.5, 2, 1, 2, 1, 0, 1, 1, 0.5, 2, 1, 1, 1, 2, 1],
        },
        {
            name: 'Flying',
            on: false,
